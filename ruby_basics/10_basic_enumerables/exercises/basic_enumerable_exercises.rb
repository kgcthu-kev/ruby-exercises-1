def display_current_inventory(inventory_list)
  ...
  inventory_list.each {|list_item,quantity| puts "#{list_item}, quantity: #{quantity}"}
end
...
def find_low_inventory(inventory_list)
  ...
  inventory_list.select do |key,inventory_item|
    inventory_item < 4
  end
end
...
# bundle exec rspec spec/basic_enumerable_exercises_spec.rb